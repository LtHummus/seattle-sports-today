...
func RenderPage(results *events.EventResults) ([]byte, error) {
	...
	err := pageTemplate.Execute(buf, &templateParams{Events: results.TodayEvent, Tomorrow: results.TomorrowEvents, GeneratedDate: generatedDateString, FullGeneratedDate: generatedTimestamp})
	if err != nil {
